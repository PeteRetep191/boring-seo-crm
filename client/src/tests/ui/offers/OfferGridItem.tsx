...
import { Button, Card, CardBody, CardFooter, CardHeader, Checkbox, Tooltip } from "@heroui/react";
      ...
      <CardBody className="p-2">
        <div className="flex flex-col">
          ...
          <div className="mt-auto flex items-center justify-between">
            <RatingStars value={item.rating} size={14} colorClass="text-yellow-400" />
            <div className="text-sm font-semibold">${item.priceUSD.toFixed(2)}</div>
          </div>
        </div>
      </CardBody>
